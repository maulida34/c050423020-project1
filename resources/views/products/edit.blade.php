...
@enderror" name="title" value="{{ old('title', $product->title) }}" placeholder="Masukkan 
Judul Product"> 
...
@enderror" name="price" value="{{ old('price', $product->price) }}" 
...
@enderror" name="stock" value="{{ old('stock', $product->stock) }}" 
